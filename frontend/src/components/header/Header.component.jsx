    ...
    <header className='pb-6 bg-white lg:pb-0'>
      <div className='px-4 mx-auto max-w-7xl sm:px-6 lg:px-8'>
        <nav className='flex items-center justify-between h-16 lg:h-20'>
          ...
          <div className={`hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10 ${menuOpen ? 'block' : ''}`}>
            <a
              href='#'
              title=''
        ...
        <nav className={`pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden ${menuOpen ? 'block' : 'hidden'}`}>
