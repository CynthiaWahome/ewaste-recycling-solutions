      ...
      <div className='px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl'>
        <div className='grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12'>
          <div className='col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8'>
            <img className='w-auto h-9' src='https://img.icons8.com/?size=100&id=ngxhKjJtc4LX&format=png&color=000000' alt='' />

            <p className='text-base leading-relaxed text-gray-600 mt-7'>Yeah, I din't know what to write in the footer, so I just added some stuff, OOps!! Sneeze.</p>
        ...
        <p className='text-sm text-center text-gray-600'>© Copyright E-waste 2024 </p>
      </div>
    </section>
